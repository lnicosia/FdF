...
/*   Updated: 2019/01/31 15:33:54 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	plot_line_low_z(t_coord2 c[2], t_env data, int color,
...
void	plot_line_high_z(t_coord2 c[2], t_env data, int color,
		t_fcoord3 vertices[3])
{
	int	dx;
	int	dy;
