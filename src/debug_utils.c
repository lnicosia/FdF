...
/*   Updated: 2019/01/09 12:20:01 by lnicosia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_axes(t_env *data)
{
	...
	{
		plot_line(new_coord2(200, data->s_height / 2), new_coord2(data->s_width, data->s_height / 2), *data, 0);
		plot_line(new_coord2(data->s_width / 2 + 100, 0), new_coord2(data->s_width / 2 + 100, data->s_height), *data, 0);
	}
}
